...
> **연관 파일**: `infolink-agent-common/.../step/SourceToIfStep.java` — batchUpdate() + catch 블록에서 개별 fallback
...
> **연관 파일**
> - `infolink-agent-common/.../step/SourceToIfStep.java` — buildUpsertSql() (PG ON CONFLICT / MySQL ON DUPLICATE KEY 분기)
> - `infolink-api-collector/.../service/ApiExecutionService.java` — PG ON CONFLICT SQL 생성
> - `infolink-agent-bojo-dmz/.../loader/repository/TargetRepositoryService.java` — batchUpsertJewon(), batchUpsertObsvData()
...
> - `infolink-agent-common/.../step/SourceToIfStep.java` — JdbcTemplate 내부에서 PreparedStatement 사용
...
> - `infolink-orchestrator-backend/.../schedule/ScheduleService.java` — 스케줄 CRUD
> - `infolink-orchestrator-backend/.../execution/ExecutionService.java` — 실행 트리거
> - `infolink-agent-common/.../service/ExecutionService.java` — 실행 이력 기록
...
### Agent 파이프라인 실행 엔진 [infolink-agent-common의 SourceToIfStep]
...
> **연관 파일**
> - `infolink-agent-common/.../step/SourceToIfStep.java` — execute(), batchUpdate + fallback
> - `infolink-agent-bojo-dmz/.../loader/step/DmzBojoLoadStep.java` — DMZ Loader Step
> - `infolink-agent-bojo-dmz/.../loader/step/LoaderStepHelper.java` — processJewon(), processObsvdata()
> - `infolink-agent-bojo-dmz/.../loader/repository/TargetRepositoryService.java` — batch UPSERT SQL
