...
/**
 * IF_RSV 약수터 수질검사 엔티티 (Internal Oracle).
 * 테이블: IF_RSV_TD_GD010310
 * 테이블 코멘트는 DDL 또는 별도 SQL 로 관리 (다른 IF_RSV entity 와 일관 — 어노테이션 미사용).
 */
@Entity
@Table(name = "IF_RSV_TD_GD010310",
       indexes = @Index(name = "idx_if_rsv_td_gd010310_exec_id", columnList = "execution_id"))
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class IfRsvTdGd010310 {
