...
@Table(name = "td_gd010310", uniqueConstraints = {
        @UniqueConstraint(name = "uk_td_gd010310_check", columnNames = {"brnch_no", "yr", "qtr", "wtsmp_ymd"})
})
@org.hibernate.annotations.Table(appliesTo = "td_gd010310", comment = "약수터수질검사결과수집API")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class YaksoterWqResult {
