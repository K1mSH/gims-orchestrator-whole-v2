package com.infolink.agent.bojo.loader.repository;
...
import com.infolink.agent.bojo.entity.target.LinkNgwis;
...
public class TargetRepositoryService {
    ...
    public List<IfRsvSecJewon> findIfRsvJewonForResync(
            java.util.List<com.infolink.agent.common.step.ExecutionCondition> conditions) {
        String dbType = entityManagerService.getTargetDbType();
        com.infolink.agent.common.step.ConditionBuilder.WhereClause where =
                com.infolink.agent.common.step.ConditionBuilder.build(conditions, dbType);
