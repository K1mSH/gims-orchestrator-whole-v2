      ...
      <div className="card">
        <div style={sectionStyle}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div style={{ fontSize: '0.85rem', fontWeight: 600 }}>기본 정보</div>
      ...
      <div style={sectionStyle}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
          ...
          <div><div style={fieldLabel}>Datasource ID</div>
            <input className="form-input" value={form.datasourceId}
              onChange={e => setForm({ ...form, datasourceId: e.target.value })} /></div>
          <div><div style={fieldLabel}>테이블명</div>
            <input className="form-input" value={form.tableName}
          ...
          <div><div style={fieldLabel}>정렬 컬럼</div>
            <input className="form-input" value={form.orderByColumn}
              onChange={e => setForm({ ...form, orderByColumn: e.target.value })} /></div>
          <div><div style={fieldLabel}>정렬 방향</div>
            <select className="form-input" value={form.orderByDirection}
