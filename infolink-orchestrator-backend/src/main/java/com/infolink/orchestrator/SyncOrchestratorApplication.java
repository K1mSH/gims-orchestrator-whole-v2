package com.infolink.orchestrator;
 ...
 *
 * <p>com.infolink.agent.common.config 패키지만 추가 스캔 — ApiKeyFilter 자동 등록용.
 * Agent 전용 controller / service / repository 가 있는 다른 common 하위 패키지는 스캔 X
 * (ExecutionService 등 Backend 자체 빈과 이름 충돌 회피).
 */
@SpringBootApplication
@EnableScheduling
@ComponentScan(basePackages = {"com.infolink.orchestrator", "com.infolink.agent.common.config"})
