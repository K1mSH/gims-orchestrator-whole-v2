...
| io.spring.dependency-management plugin | 1.1.0 | infolink-agent-common 포함 전 모듈 |

---

## 1. infolink-agent-common (BOM 적용 후 — 명시 버전만)
...
사용 모듈: infolink-agent-common, infolink-auth, infolink-orchestrator-backend
...
| GAV | 버전 | 사용 모듈 |
|-----|------|----------|
| com.oracle.database.jdbc:ojdbc8 | 19.3.0.0 | agent-bojo-int, agent-others, agent-provide, proxy-dmz, proxy-internal, orchestrator/backend, infolink-api-provider |

---

## 5. Frontend (infolink-orchestrator-frontend, npm)
...
| GAV | 사용 모듈 | 비고 |
|-----|----------|------|
| com.oracle.database.jdbc:ojdbc8 | infolink-agent-others-dmz, infolink-agent-provide-dmz, infolink-proxy-dmz, infolink-api-provider | |
| com.oracle.database.jdbc:ojdbc11 | infolink-agent-bojo-internal, infolink-proxy-internal, infolink-orchestrator-backend | |
| org.postgresql:postgresql | 거의 모든 모듈 | |
| com.mysql:mysql-connector-j | infolink-agent-bojo-dmz, infolink-proxy-dmz, infolink-proxy-internal | |
| com.h2database:h2 | infolink-agent-bojo-dmz, infolink-agent-bojo-internal, infolink-orchestrator-backend, infolink-api-collector | |
