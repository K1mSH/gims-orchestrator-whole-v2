...
public class ExecutionCondition {
    ...
    public static ExecutionCondition eq(String column, String value) {
        return new ExecutionCondition(column, ConditionOperator.EQ, value, null);
    }

    public static ExecutionCondition neq(String column, String value) {
        return new ExecutionCondition(column, ConditionOperator.NEQ, value, null);
    }

    public static ExecutionCondition gt(String column, String value) {
        return new ExecutionCondition(column, ConditionOperator.GT, value, null);
    }

    public static ExecutionCondition gte(String column, String value) {
        return new ExecutionCondition(column, ConditionOperator.GTE, value, null);
    }

    public static ExecutionCondition lt(String column, String value) {
        return new ExecutionCondition(column, ConditionOperator.LT, value, null);
    }

    public static ExecutionCondition lte(String column, String value) {
        return new ExecutionCondition(column, ConditionOperator.LTE, value, null);
    }

    public static ExecutionCondition between(String column, String from, String to) {
        return new ExecutionCondition(column, ConditionOperator.BETWEEN, from, to);
    }

    public static ExecutionCondition in(String column, String commaSeparatedValues) {
        return new ExecutionCondition(column, ConditionOperator.IN, commaSeparatedValues, null);
    }

    public static ExecutionCondition like(String column, String pattern) {
        return new ExecutionCondition(column, ConditionOperator.LIKE, pattern, null);
    }

    public static ExecutionCondition isNull(String column) {
        return new ExecutionCondition(column, ConditionOperator.IS_NULL, null, null);
    }

    public static ExecutionCondition isNotNull(String column) {
        return new ExecutionCondition(column, ConditionOperator.IS_NOT_NULL, null, null);
    }
}
