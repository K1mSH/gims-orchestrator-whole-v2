package com.sync.agent.provide.controller;

import com.sync.agent.provide.config.pipeline.AgentConfigLoader;
import com.sync.agent.provide.config.pipeline.AgentDefinition;
import com.sync.agent.provide.config.pipeline.PipelineRegistry;
import com.sync.agent.provide.pipeline.PipelineService;
...
public class PipelineController {
    ...
    public ResponseEntity<?> execute(@RequestBody Map<String, Object> request) {
        log.info("[Provide] 파이프라인 실행 요청: {}", request);
        ...
        try {
            ...
            log.info("[Provide] 파이프라인 실행 수락: executionId={}, agentCode={}", executionId, agentCode);
            ...
            log.error("[Provide] 파이프라인 실행 시작 실패", e);
    ...
    public ResponseEntity<?> getPipelineTables(@PathVariable String agentCode) {
        ...
        log.info("[Provide] 파이프라인 테이블 목록 {}: {}", agentCode, tables);
    ...
    public ResponseEntity<List<Map<String, Object>>> getAgentInfo() {
        ...
        log.info("[Provide] Agent 정보 조회: {} 개 Agent", result.size());
