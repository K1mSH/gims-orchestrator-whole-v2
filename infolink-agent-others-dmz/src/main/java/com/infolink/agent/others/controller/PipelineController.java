package com.infolink.agent.others.controller;

import com.infolink.agent.others.config.pipeline.AgentConfigLoader;
import com.infolink.agent.others.config.pipeline.AgentDefinition;
import com.infolink.agent.others.config.pipeline.PipelineRegistry;
import com.infolink.agent.others.pipeline.PipelineService;
...
public class PipelineController {
    ...
    public ResponseEntity<?> getPipelineTables(@PathVariable String agentCode) {
        ...
        log.info("[Others] 파이프라인 테이블 목록 {}: {}", agentCode, tables);
    ...
    public ResponseEntity<List<Map<String, Object>>> getAgentInfo() {
        ...
        log.info("[Others] Agent 정보 조회: {} 개 Agent", result.size());
